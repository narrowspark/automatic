...
final class ConfiguratorInstallerTest extends MockeryTestCase
{
    ...
    /**
     * @var \Narrowspark\Automatic\Installer\ConfiguratorInstaller
     */
    ...
    {
        static::assertTrue($this->configuratorInstaller->supports('automatic-configurator'));
    }

    public function testInstallWithEmptyPsr4(): void
    {
        $this->expectException(\UnexpectedValueException::class);
        $this->expectExceptionMessage('Error while installing "prisis/test", automatic-configurator packages should have a namespace defined in their psr4 key to be usable.');
